APP_CONFIG = {
  ...
  behaviorSquares: [
    ...
    { do:'zoomIn animated', to:'$find body | .fa' },
    { do:'bounceIn animated', to:'$ancestors target | .container-box' },
    { do:'flip animated', to:'$closest target, after: $removeAnim' },
    { do:'wobble animated', to:'.container-box' },
    { do:'rollOut animated', to:'.demo1, after: $removeAnim' },
    { do:'zoomIn animated', to:'h3' },
